...
public class TOMEntitiesRegistry {
    ...
    public static final RegistryObject<EntityType<GiantEntity>> GIANT = register("rolling_giant", EntityType.Builder.of(GiantEntity::new, MobCategory.MISC).sized(1.4F, 2.7F));
