...
public class GiantModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(TheOldestMine.MODID, "rolling_giant"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 128).addBox(-6.5F, -13.2F, -6.7F, 13.0F, 16.0F, 11.0F, new CubeDeformation(0.5F))
